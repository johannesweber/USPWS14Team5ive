...
protocol AddExistingGoalTableViewControllerDelegate: class {
...
class AddExistingGoalTableViewController: UITableViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    
    //variables

    weak var delegate: AddExistingGoalTableViewControllerDelegate?
    ...
    @IBAction func done (sender: UIBarButtonItem) {
        ...
        self.delegate?.addExistingGoalTableViewController(self, didFinishAddingItem: newGoalItem)
    }
